...
RUN mkdir virtual-smart-structures-and-dynamics-laboratory-iitd

COPY src/ /virtual-smart-structures-and-dynamics-laboratory-iitd/src

WORKDIR ./virtual-smart-structures-and-dynamics-laboratory-iitd/src
